...
% 注释
\node[right=0.3cm of mr_disk1, font=\scriptsize, text=red, align=left] {每次中间结果\\写入磁盘};
\node[left=0.3cm of sp_t2, font=\scriptsize, text=blue!70!black, align=left] {中间结果\\保持在内存};
